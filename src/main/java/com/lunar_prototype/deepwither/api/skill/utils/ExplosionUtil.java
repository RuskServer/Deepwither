...
public class ExplosionUtil {
    ...
    public static void triggerExplosionArrowEffect(LivingEntity caster, Location location) {
        triggerExplosionArrowEffect(caster, location, 1.0);
    }

    /**
     * Explosion Arrowの爆発効果（演出 + ダメージ + デバフ）を倍率指定で一括処理します。
     */
    public static void triggerExplosionArrowEffect(LivingEntity caster, Location location, double damageMultiplier) {
        ...
        double multiplier = 1.2 * damageMultiplier;
