...
public class SkillRegistry implements IManager {
    ...
    public void init() {
        ...
        register("support_heal", new com.lunar_prototype.deepwither.api.skill.SupportHealSkill());
        ...
        register("celestial_heal", new com.lunar_prototype.deepwither.api.skill.CelestialHealSkill());
    }
